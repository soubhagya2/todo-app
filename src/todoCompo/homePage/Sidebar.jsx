...
export function Sidebar({ tasks = [], user }) {
  ...
  return (
    <aside className="h-screen w-[250px] shrink-0 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-[#0F172A] flex flex-col">
